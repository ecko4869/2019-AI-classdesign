    ...
    def train(self, training_inputs, training_outputs):
        ...
        for o in range(len(self.output_layer.neurons)):
            for w_ho in range(len(self.output_layer.neurons[o].weights)):
                ...
                self.output_layer.neurons[o].weights[w_ho] -= self.LERANING_RATE * pd_error_wrt_weight
        ...
        for h in range(len(self.hidden_layer.neurons)):
            for w_ih in range(len(self.hidden_layer.neurons[h].weights)):
                ...
                self.hidden_layer.neurons[h].weights[w_ih] -= self.LERANING_RATE * pd_error_wrt_weight

    # LERANING_RATE

    def calculate_total_error(self, traning_sets):
        total_error = 0
        for t in range(len(traning_sets)):
            traning_inputs, traning_outputs = traning_sets[t]
            self.feed_forward(traning_inputs)
            for o in range(len(traning_outputs)):
                total_error += self.output_layer.neurons[o].calculate_error(traning_outputs[o])
        return total_error
